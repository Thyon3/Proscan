...
final searchResultsProvider = FutureProvider.family<PaginatedDocuments, SearchParams>((ref, params) async {
...
final currentSearchResultsProvider = FutureProvider<PaginatedDocuments>((ref) {
  ...
  return ref.watch(searchResultsProvider(SearchParams(
    query: query,
    scanMode: scanMode,
